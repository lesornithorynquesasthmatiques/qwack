...
public class CityBatchRunnerTest {
	...
	private static final String CITIES_FILE = "src/test/resources/hdf/cities.h5";
	...
	public void should_read_and_write_4_sensors() throws Exception {
		...
		MongoWriter<Sensor> writer = new MongoWriter<Sensor>(
			...
			"sensors");
		CityBatchRunner<Sensor> runner = new CityBatchRunner<Sensor>();
